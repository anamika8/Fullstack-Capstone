...
describe('Comment section', function () {
    ...
    */
    function seedCommentsData() {
        ...
        const forumsSeedData = seedForumsData();
        const seedData = [];
        for (let i = 0; i <= 1; i++) {
            seedData.push({
                _id: mongoose.Types.ObjectId(),
        ...
        it('should return comments with right fields', function () {
            ...
            return chai.request(app)
                ...
                .then(function (Comment) {
                    ...
                    expect(commentContent.user).to.equal(Comment.user.firstName + " " + Comment.user.lastName);
        ...
        it('should add a new comment in forum', function () {
            ...
            return chai.request(app)
                ...
                .then(function (remark) {
                    ...
                    expect(remark.body.user).to.equal(`${newUser.firstName} ${newUser.lastName}`);
